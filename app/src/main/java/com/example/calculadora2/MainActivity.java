...
public class MainActivity extends AppCompatActivity {
    ...
    public void apagar(View aaaa){
        //um só ou tudo q apaga?
        try {
            pilha.pop();
            mostrar();
        }
        catch (Exception e) {
            resultado.setText("acabou a pilha fi :/");
        }
    }
    ...
    public void somar(View v) {
        try {
            ...
            resultado.setText("não tem elementos o suficiente na pilhaaaa\n"+ pilha.toString());
        }
    ...
    public void subtrair(View view) {
        try {
            ...
            resultado.setText("uai, deu ruim fi");
        }
    }
